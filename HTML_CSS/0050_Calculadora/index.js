...
botonBorra.addEventListener("click", () => {
    ...
    pantalla.innerHTML = resultadoActual.substring(
        0,
        resultadoActual.length - 1
    );
});
    ...
    botonGenerico.addEventListener("click", () => {
        ...
        if (
            ...
            if (botonGenerico.innerHTML == "x") {
                ...
                pantalla.innerHTML =
                    pantalla.innerHTML + botonGenerico.innerHTML;
            ...
            if (botonGenerico.innerHTML == "x") {
                ...
                pantalla.innerHTML =
                    pantalla.innerHTML + "0" + botonGenerico.innerHTML;
            }
        } else {
...
botonPunto.addEventListener("click", () => {
    ...
    if (resultadoActual == 0 || resultadoActual == "") {
        ...
        (ultimoCaracter == "+" ||
            ...
            ultimoCaracter == "*" ||
            ultimoCaracter == "/") &&
        ultimoCaracterCadenaInterna == "."
    ) {
        pantalla.innerHTML = resultadoActual + "0.";
        console.log("estas en el segundo else if");
    } else if (
        Number.isInteger(converFlotanteDos) &&
        converFlotanteDos > 0 &&
        numerPuntos == 0
    ) {
        // evita que en el primer ingreso se colocquen 2 puntos
